...
//   const suzuki = new Car('Nissan', 'Murano', 31700);
//   console.log(suzuki);
...
// ----------------------------Task 6 Module 5----------------------------
// Свойство prototype. Задача: Хранилище
...
// ----------------------------Task 7 Module 5----------------------------
// Свойство prototype. Задача: Конструктор строк
...
// Выполни рефакторинг класса Car. Сделай свойства model и price 
// приватными, также как #brand. Стандартизируй публичный интерфейс 
// класса заменив уже объявленные методы на геттеры и сеттеры brand, 
...
// Если цена автомобиля превышает максимальную, метод должен 
// вернуть строку 'Внимание! Цена превышает допустимую.'.
